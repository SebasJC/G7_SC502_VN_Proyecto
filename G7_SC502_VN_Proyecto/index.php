...
<body>
  ...
  <header class="bg-light py-3 border-bottom">
    <div class="container d-flex justify-content-between align-items-center">
      ...
      <nav>
        ...
        <a href="perfil.html" class="me-3 text-decoration-none">Perfil</a>
        <a href="carrito.html" class="me-3 text-decoration-none">Carrito</a>
      </nav>
    </div>
  </header>
  ...
  <footer class="bg-light py-3 border-top text-center">
    <small>&copy; 2025 PuraCletaCR - Promoviendo la salud en Costa Rica</small>
  </footer>
</body>
</html>